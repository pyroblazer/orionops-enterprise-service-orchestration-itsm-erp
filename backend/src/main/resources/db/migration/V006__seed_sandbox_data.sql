...
VALUES
    (sandbox_uuid('es_001'), 'incident', sandbox_uuid('inc_001'),
     'incident_created', 1,
     '{"incident_number": "INC-001", "title": "Production database unreachable", "priority": "critical", "status": "open"}'::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111102", "correlation_id": "corr-inc-001-create", "tenant_id": "00000000-0000-0000-0000-000000000001"}'::jsonb,
     NOW() - INTERVAL '3 hours'),

    (sandbox_uuid('es_002'), 'incident', sandbox_uuid('inc_001'),
     'incident_assigned', 1,
     ('{"incident_id": "' || sandbox_uuid('inc_001') || '", "assignee_id": "a1a1a1a1-1111-1111-1111-111111111103", "assignment_type": "escalation", "previous_assignee_id": "a1a1a1a1-1111-1111-1111-111111111102"}')::jsonb,
     ('{"user_id": "a1a1a1a1-1111-1111-1111-111111111101", "correlation_id": "corr-inc-001-assign", "causation_id": "' || sandbox_uuid('es_001') || '"}')::jsonb,
     NOW() - INTERVAL '2 hours 45 minutes'),

    (sandbox_uuid('es_003'), 'incident', sandbox_uuid('inc_008'),
     'incident_escalated', 1,
     ('{"incident_id": "' || sandbox_uuid('inc_008') || '", "from_priority": "high", "to_priority": "critical", "reason": "Network-wide outage confirmed"}')::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111101", "correlation_id": "corr-inc-008-escalate"}'::jsonb,
     NOW() - INTERVAL '10 days' + INTERVAL '5 minutes'),

    (sandbox_uuid('es_004'), 'incident', sandbox_uuid('inc_008'),
     'incident_resolved', 1,
     ('{"incident_id": "' || sandbox_uuid('inc_008') || '", "resolution_code": "resolved_permanently", "resolution_notes": "Replaced failed switch module. Network restored.", "resolved_at": "' || (NOW() - INTERVAL '10 days' + INTERVAL '45 minutes') || '"}')::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111103", "correlation_id": "corr-inc-008-resolve"}'::jsonb,
     NOW() - INTERVAL '10 days' + INTERVAL '45 minutes'),

    (sandbox_uuid('es_005'), 'problem', sandbox_uuid('prb_001'),
     'problem_created', 1,
     ('{"problem_number": "PRB-001", "title": "Recurring database connection pool exhaustion", "priority": "critical", "linked_incident_id": "' || sandbox_uuid('inc_001') || '"}')::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111101", "correlation_id": "corr-prb-001-create"}'::jsonb,
     NOW() - INTERVAL '1 day'),

    (sandbox_uuid('es_006'), 'change_request', sandbox_uuid('chg_003'),
     'change_submitted', 1,
     '{"change_number": "CHG-003", "change_type": "normal", "title": "Upgrade PostgreSQL from 15.4 to 15.6", "risk_level": "medium", "submitted_by": "a1a1a1a1-1111-1111-1111-111111111104"}'::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111104", "correlation_id": "corr-chg-003-submit"}'::jsonb,
     NOW() - INTERVAL '5 days'),

    (sandbox_uuid('es_007'), 'change_request', sandbox_uuid('chg_003'),
     'change_approved', 1,
     '{"change_number": "CHG-003", "approved_by": "a1a1a1a1-1111-1111-1111-111111111104", "comments": "Risk assessment reviewed. Approved for implementation."}'::jsonb,
     ('{"user_id": "a1a1a1a1-1111-1111-1111-111111111104", "correlation_id": "corr-chg-003-approve", "causation_id": "' || sandbox_uuid('es_006') || '"}')::jsonb,
     NOW() - INTERVAL '3 days'),

    (sandbox_uuid('es_008'), 'change_request', sandbox_uuid('chg_001'),
     'change_implemented', 1,
     ('{"change_number": "CHG-001", "implemented_by": "a1a1a1a1-1111-1111-1111-111111111103", "implemented_at": "' || (NOW() - INTERVAL '7 days' + INTERVAL '1 hour 45 minutes') || '", "notes": "Deployment successful. All smoke tests passed."}')::jsonb,
     '{"user_id": "a1a1a1a1-1111-1111-1111-111111111103", "correlation_id": "corr-chg-001-implement"}'::jsonb,
     NOW() - INTERVAL '7 days' + INTERVAL '1 hour 45 minutes'),

    (sandbox_uuid('es_009'), 'sla', sandbox_uuid('sla_inst_001'),
     'sla_created', 1,
     ('{"sla_definition_id": "' || sandbox_uuid('sla_def_critical') || '", "entity_type": "incident", "entity_id": "' || sandbox_uuid('inc_001') || '", "response_target_minutes": 15, "resolution_target_minutes": 240}')::jsonb,
     '{"correlation_id": "corr-sla-inst-001-create", "system": "sla-engine"}'::jsonb,
     NOW() - INTERVAL '3 hours'),

    (sandbox_uuid('es_010'), 'sla', sandbox_uuid('sla_inst_004'),
     'sla_breach_warning', 1,
     ('{"sla_definition_id": "' || sandbox_uuid('sla_def_critical') || '", "entity_type": "incident", "entity_id": "' || sandbox_uuid('inc_008') || '", "breach_type": "resolution", "breached_by_minutes": 5}')::jsonb,
     '{"correlation_id": "corr-sla-inst-004-breach", "system": "sla-engine"}'::jsonb,

...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      'hover:bg-secondary focus:outline-none focus:ring-[var(--focus-width)] focus:ring-ring disabled:pointer-events-none disabled:opacity-50',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      'hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-[var(--focus-width)] focus:ring-ring',
